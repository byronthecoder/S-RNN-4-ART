...
S-RNN-4-ART model is a neural network designed to detect and mesure phonetic convergence and speech imitation.

This code reposotory is a demo of the Siamese RNN model described in the paper:
